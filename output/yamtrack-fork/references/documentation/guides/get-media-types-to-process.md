# How To: Get Media Types To Process
...
Workflow: Test the _get_media_types_to_process method.
...
### Step 1: 'Test the _get_media_types_to_process method.'
...
### Step 3: Assign media_types = manager._get_media_types_to_process(...)
...
### Step 5: Assign media_types = manager._get_media_types_to_process(...)
...
### Step 12: Assign self.user.anime_enabled = False

```python
self.user.anime_enabled = False
```

### Step 13: Assign self.user.manga_enabled = False

```python
self.user.manga_enabled = False
```

### Step 14: Call self.user.save()

```python
self.user.save()
```

### Step 15: Assign media_types = manager._get_media_types_to_process(...)
...
*Source: test_media_manager.py:532 | Complexity: Advanced | Last updated: 2026-05-22*