# How To: Get Media List Sort By Regular Field
...
Workflow: Test the get_media_list method with sorting by regular field.
...
### Step 1: 'Test the get_media_list method with sorting by regular field.'
...
### Step 3: Assign anime_item2 = Item.objects.create(...)
...
*Source: test_media_manager.py:503 | Complexity: Intermediate | Last updated: 2026-05-22*