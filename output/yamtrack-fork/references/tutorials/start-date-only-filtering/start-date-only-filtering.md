# How To: Start Date Only Filtering
...
Workflow: Test filtering for media with only start date.
...
### Step 1: 'Test filtering for media with only start date.'
...
*Source: test_statistics.py:294 | Complexity: Advanced | Last updated: 2026-05-22*