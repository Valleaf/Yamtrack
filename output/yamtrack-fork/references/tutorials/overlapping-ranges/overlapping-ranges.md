...
Workflow: Test media with date ranges that overlap with the filter range.
...
### Step 1: 'Test media with date ranges that overlap with the filter range.'
...
### Step 8: Assign spanning_item = Item.objects.create(...)
...
### Step 9: Call Movie.objects.create()
...
### Step 10: Assign unknown = statistics.get_user_media(...)

```python
user_media, _ = statistics.get_user_media(self.user, start_date, end_date)
```

### Step 11: Assign movie_ids = value
...
*Source: test_statistics.py:408 | Complexity: Advanced | Last updated: 2026-05-22*