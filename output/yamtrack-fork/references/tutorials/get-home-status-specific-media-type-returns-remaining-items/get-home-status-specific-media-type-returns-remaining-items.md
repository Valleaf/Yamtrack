# How To: Get Home Status Specific Media Type Returns Remaining Items
...
Workflow: Test get_home_status returns the remaining items for load-more.
...
### Step 1: 'Test get_home_status returns the remaining items for load-more.'
...
### Step 3: Assign initial_page = manager.get_home_status(...)
...
### Step 4: Assign load_more_page = manager.get_home_status(...)
...
### Step 11: Call Book.objects.create()
...
*Source: test_media_manager.py:663 | Complexity: Advanced | Last updated: 2026-05-22*